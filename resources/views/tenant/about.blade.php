...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('user-template/images/about-image.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section ftco-about">
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(user-template/images/about-image1.jpg);">
					</div>
	...
	<section class="ftco-section ftco-intro" style="background-image: url(user-template/images/about-image.jpg);">
			<div class="overlay"></div>
			<div class="container">
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap rounded text-center py-4 pb-5">
                  ...
                  <div class="text pt-4">
                    <p class="mb-4">Stay Haven made finding my dream home a breeze! The support was exceptional, and I couldn't have asked for a better experience. Highly recommended!</p>
